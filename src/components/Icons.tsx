  ...
  return (
    ...
    >
      <g fill="none" fill-rule="evenodd" data-reactid="9">
        ...
        <path
          fill="#F7D032"
          d="m153.303 133.42-24.278.011 24.278.018z"
          data-reactid="12"
        />
        <path
          fill="#FFF"
        ...
        <g data-reactid="20">
          <path
            ...
            stroke-width="2"
            d="m162.369 44.033-9.286 10.683"
            data-reactid="21"
          />
          <path
            fill="#E6E6E6"
            d="m177.11 39.194-4.262 4.902c-2.12 2.44-6.34 2.241-9.423-.438-3.083-2.68-3.866-6.831-1.746-9.27l14.488-16.667 13.418-15.436c2.118-2.436 6.339-2.239 9.422.44 3.082 2.68 3.865 6.833 1.747 9.269"
            data-reactid="22"
          />
          <path
            stroke="#CCC"
